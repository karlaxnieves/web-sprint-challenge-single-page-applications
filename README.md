...
End to end testing is a method that invovles testing an application from beginning to end. By doing this you basically replicate real user scenarios so that the system can be validated for integration and data integrity.
